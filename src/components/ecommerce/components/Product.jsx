  ...
  return (
    <div className="p-2 rounded-xl transition hover:bg-gray-400/10 hover:scale-101">
      ...
      <button
        ...
        className={isInCart ? "mt-4 w-full rounded-lg bg-red-600 px-4 py-2 text-sm font-bold text-white transition hover:bg-red-500" : "mt-4 w-full rounded-lg bg-green-700 px-4 py-2 text-sm font-bold text-white transition hover:bg-green-600"}
      >
